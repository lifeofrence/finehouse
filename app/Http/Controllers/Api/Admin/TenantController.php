...
class TenantController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['message' => "Tenant account created for {$user->name}. They can now login with 'password123' and complete their profile."]);
    }
    ...
    public function index(Request $request)
    {
        ...
        return response()->json(compact('tenants', 'properties', 'propertyId', 'search'));
    }
    ...
    public function show(User $tenant)
    {
        ...
        return response()->json(compact('tenant', 'daysLeft'));
    }
    ...
    public function rentDetails(User $tenant)
    {
        ...
        return response()->json(compact('tenant', 'totalPaid', 'annualRent', 'leaseMonths', 'totalLeaseValue', 'balance', 'walletBalance'));
    }
    ...
    public function update(Request $request, User $tenant)
    {
        ...
        return response()->json(['message' => 'Tenant information updated successfully.']);
    }
