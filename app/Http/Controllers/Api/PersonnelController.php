...
class PersonnelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->json(compact('personnel', 'properties', 'propertyId', 'search', 'companies', 'targetCompanyId'));
    }
    ...
    public function create()
    {
        ...
        return response()->json(compact('properties', 'companies'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json(['message' => 'Personnel registered successfully.']);
    }
    ...
    public function edit(User $personnel)
    {
        ...
        return response()->json(compact('personnel', 'properties', 'companies'));
    }
