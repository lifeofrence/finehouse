...
class PaymentController extends Controller
{
    ...
    public function create()
    {
        ...
        if (!$booking) {
            return redirect()->route('dashboard')->with('error', 'You need an active or approved room booking to make a payment.');
        }
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->is_external) {
            ...
            return redirect($initialization['data']['authorization_url']);
        }
    ...
    public function handleGatewayCallback(Request $request)
    {
        ...
        if ($response && $response['status'] && $response['data']['status'] === 'success') {
            ...
            if ($payment && $payment->status !== 'verified') {
                ...
                return redirect()->route('payments.index')->with('success', 'Payment successful and verified!');
            }
        }
