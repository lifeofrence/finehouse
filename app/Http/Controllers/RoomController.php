...
class RoomController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('room.index', compact('rooms', 'selectedProperty', 'properties', 'propertyId', 'search', 'movingTenant'));
    }
    ...
    public function assignment(Request $request)
    {
        ...
        return view('room.assignment', compact('rooms', 'properties', 'propertyId'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('room.create', compact('properties', 'preSelectedPropertyId'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('room.edit', compact('room', 'properties'));
    }
    ...
    public function showAssignForm(Room $room, Request $request)
    {
        ...
        if ($occupancyCount >= $room->capacity) {
            return redirect()->route('rooms.show', $room->id)->with('error', 'This room is already at its maximum capacity (' . $room->capacity . ').');
        }
        ...
        return view('room.assign', compact('room', 'tenants', 'occupancyCount', 'preselectedTenantId'));
    }
    ...
    public function assign(Request $request, Room $room)
    {
        ...
        return redirect()->route('rooms.show', $room->id)->with('success', 'Tenant has been assigned. Room occupancy: ' . ($occupancyCount + 1) . '/' . $room->capacity);
    }
    ...
    public function unassign(Request $request, Room $room, \App\Models\Booking $booking)
    {
        ...
        return redirect()->route('rooms.show', $room->id)->with('success', 'Tenant has been removed from this room.');
    }
}
